  ...
  Future<void> _fetch() async {
    ...
    final List<Map<String, dynamic>> staffData =
        canAssignClientOwner
            ...
            : <Map<String, dynamic>>[];
    final List<Map<String, dynamic>> staffFilterRows = await widget.apiService
    ...
    setState(() {
      ...
      final List<dynamic> paymentList =
          (paymentPayload['data'] ?? []) as List<dynamic>;
  ...
  Future<void> _fetchMore() async {
    ...
    if (clientsPage < clientsLastPage) {
      ...
      if (mounted) {
        ...
        setState(() {
          clients.addAll(
            newList.map((e) => e as Map<String, dynamic>).toList(),
          );
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          if (['admin', 'administrator', 'quan_ly'].contains(
                            widget.currentUserRole.toLowerCase(),
                          )) ...<Widget>[
                            SizedBox(height: kStitchTaskFormGap),
                            DropdownButtonFormField<int?>(
                  ...
                  StitchFormSheetActions(
                    primaryLoading: _savingClientForm,
                    primaryLabel:
                        _savingClientForm
                            ? (editingClientId == null
                                ? 'Đang tạo...'
            ...
            return Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  StitchFormSheetTitleBar(
                    title:
                        editingPaymentId == null
                            ? 'Ghi nhận thanh toán'
                            : 'Sửa thanh toán',
                    subtitle: 'Liên kết khoản thu với khách hàng trong CRM.',
                  ...
                  StitchFormSheetActions(
                    primaryLoading: _savingPaymentForm,
                    primaryLabel:
                        _savingPaymentForm
                            ? (editingPaymentId == null
                                ? 'Đang tạo...'
            ...
            GridView.count(
              ...
              children: <Widget>[
                ...
                StitchMetricCard(
                  ...
                  label: 'Theo dõi',
                  value: (clientsTotal + paymentsTotal).toString(),
                  ...
                  children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          const SizedBox(height: 4),
                          Text(
                            '${payment['amount']?.toString() ?? '0'} • $pStatus',
                            style: const TextStyle(
                    ...
                    if (widget.canManagePayments || widget.canDelete)
                      PopupMenuButton<String>(
                        ...
                        onSelected: (val) {
                          if (val == 'edit' && widget.canManagePayments) {
                            _openPaymentForm(payment: payment);
                          }
                          if (val == 'delete' && widget.canDelete) {
  ...
  Widget _buildBadge(String text, Color color, {bool outlined = false}) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border:
            outlined ? Border.all(color: color.withValues(alpha: 0.3)) : null,
      ),
      child: Text(
        text,
        style: TextStyle(
