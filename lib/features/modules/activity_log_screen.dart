...
class _ActivityLogScreenState extends State<ActivityLogScreen> {
  ...
  Future<void> _fetch() async {
    ...
    final Map<String, dynamic> data =
        await widget.apiService.getActivityLogs(widget.token, perPage: 30);
    if (!mounted) return;
    ...
    setState(() {
      loading = false;
      logs = (data['data'] as List<dynamic>)
        ...
        child: ListView(
          ...
          children: <Widget>[
            const StitchHeroCard(
              title: 'System log',
              subtitle: 'Theo dõi lịch sử thao tác, thay đổi trạng thái, upload.',
            ),
            ...
            ...logs.map((Map<String, dynamic> log) {
              final Map<String, dynamic>? user = log['user'] as Map<String, dynamic>?;
              final String actor =
              ...
              final String time = _formatTime((log['created_at'] ?? '').toString());
              return Container(
